...
In this code, Model SRCNN is defined that the SRCNN is different from FSRCNN mainly in three aspects. 
First, SRCNN adopts the original low-resolution image as input with bicubic interpolation. 
